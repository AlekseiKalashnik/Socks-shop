...
Приложение написанно на Java 17 используя фреймворк Spring Boot

Для версионирования схемы базы данных использовалась Liquibase

Приложение и базу данных можно запустить используя docker-compose up

Добавленные заранее цвета: WHITE, BLACK, GRAY, BROWN, RED, GREEN, BLUE, ORANGE, YELLOW, PINK, PURPLE
#
Привет!
